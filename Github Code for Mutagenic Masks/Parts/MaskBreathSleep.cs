...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
    public class MaskBreathSleep : BaseMutation
    {
        ...
        public MaskBreathSleep()
        {
            DisplayName = "[MaskBreathSleep::MaskBreathSleep()]";
		}
        ...
        {
            return "[MaskBreathSleep::GetDescription]";
        }

        public override string GetLevelText(int Level)
        {
            string Ret = "[MaskBreathSleep::GetLevelText]\n";
            return Ret;
        }
        ...
        public static bool Cast(MaskBreathSleep mutation = null)
        {
            if (mutation == null)
            {
                return false;
