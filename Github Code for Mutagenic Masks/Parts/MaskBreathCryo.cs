...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
    public class MaskBreathCryo : BaseMutation
    {
        ...
        public MaskBreathCryo()
        {
            DisplayName = "[MaskBreathCryo::MaskBreathCryo()]";
		}
        ...
        {
            return "[MaskBreathCryo::GetDescription]";
        }

        public override string GetLevelText(int Level)
        {
            string Ret = "[MaskBreathCryo::GetLevelText]\n";
            return Ret;
        }
        ...
        public static bool Cast(MaskBreathCryo mutation = null)
        {
            if (mutation == null)
            {
                return false;
