...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
	// Code here in this file is unused, but i'm keeping it in incase I want to do anything with it in this mod in the future.
    public class MaskBreathBase : BaseMutation
    {
        ...
        public MaskBreathBase()
        {
            DisplayName = "[MaskBreathBase::MaskBreathBase()]";
		}
        ...
        {
            return "[MaskBreathBase::GetDescription]";
        }

        public override string GetLevelText(int Level)
        {
            string Ret = "[MaskBreathBase::GetLevelText]\n";
            return Ret;
        }
        ...
        public static bool Cast(MaskBreathBase mutation = null)
        {
            if (mutation == null)
            {
                return false;
