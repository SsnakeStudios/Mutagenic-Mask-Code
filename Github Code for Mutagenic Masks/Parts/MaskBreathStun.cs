...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
    public class MaskBreathStun : BaseMutation
    {
        ...
        public MaskBreathStun()
        {
            DisplayName = "[MaskBreathStun::MaskBreathStun()]";
		}
        ...
        {
            return "[MaskBreathStun::GetDescription]";
        }

        public override string GetLevelText(int Level)
        {
            string Ret = "[MaskBreathStun::GetLevelText]\n";
            return Ret;
        }
        ...
        public static bool Cast(MaskBreathStun mutation = null)
        {
            if (mutation == null)
            {
                return false;
