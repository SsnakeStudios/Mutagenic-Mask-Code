...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
    public class MaskBreathConfusion : BaseMutation
    {
        ...
        public MaskBreathConfusion()
        {
            DisplayName = "[MaskBreathConfusion::MaskBreathConfusion()]";
		}
        ...
        {
            return "[MaskBreathConfusion::GetDescription]";
        }

        public override string GetLevelText(int Level)
        {
            string Ret = "[MaskBreathConfusion::GetLevelText]\n";
            return Ret;
        }
        ...
        public static bool Cast(MaskBreathConfusion mutation = null)
        {
            if (mutation == null)
            {
                return false;
