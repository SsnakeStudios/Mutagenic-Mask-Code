...
namespace XRL.World.Parts.Mutation
{
    ...
    [Serializable]
    public class MaskBreath_SleepBeard : MaskBreathSleep
    {


        public MaskBreath_SleepBeard()
        {
            DisplayName = "Sleepy Breath";
			return;
        }
        ...
        {
            string Ret = "Breathes sleep gas in a cone.\n";
        ...
        public override string GetGasBlueprint() => "SleepGas80";
